  ...
  return (
    ...
    >
      ...
      <div className="overflow-y-auto scrollbar-thin h-full">
        <CopyBlock
          language={`jsx`}
          text={`const name = 'Brayan Rojas'
let location = 'Maringá, Paraná, Brazil '
...
let Programming languages = 'HTML5, CSS3, Javascript, PHP, Java, C++, Python, Solidity, Rust, Golang, Ruby'
